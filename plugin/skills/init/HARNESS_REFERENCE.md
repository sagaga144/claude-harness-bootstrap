...
| Has a real deploy or release target already | wire whichever MCP fits and add the matching health check — see §1.9 (five flavors: live service, published artifact, marketplace/store submission, scheduled job, infrastructure change) | — |
...
of **five** different things depending on the profile — pick (or combine) accordingly,
